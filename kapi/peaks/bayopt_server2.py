...
fh = logging.FileHandler(f"bayopt_server2.log")
...
if __name__ == "__main__":
    ...
    for i in range(0, 300):
        ...
        ret, uniqNodes, numAllocs = checkValidParams(parameterization, res, k8sm)
        ...
        """
        ax_client.complete_trial(trial_index=trial_index, raw_data=evalpeaks(pname, ret, data_source, uniqNodes, parameterization))
        ax_client.save_to_json_file("ax_client_snapshot2.json")
