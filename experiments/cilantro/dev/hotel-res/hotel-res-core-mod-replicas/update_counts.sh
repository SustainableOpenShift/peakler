...
function updateAll {
    ...
    sed -i "s/replicas: [0-9]\+/replicas: $2/" geo/mongodb-geo-deployment.yaml
    sed -i "s/replicas: [0-9]\+/replicas: $2/" user/mongodb-user-deployment.yaml
    sed -i "s/replicas: [0-9]\+/replicas: $2/" profile/mongodb-profile-deployment.yaml
    sed -i "s/replicas: [0-9]\+/replicas: $2/" reserve/mongodb-reservation-deployment.yaml
    sed -i "s/replicas: [0-9]\+/replicas: $2/" reccomend/mongodb-recommendation-deployment.yaml
    sed -i "s/replicas: [0-9]\+/replicas: $2/" rate/mongodb-rate-deployment.yaml
}
